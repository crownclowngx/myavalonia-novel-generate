...
当前新增产品方向见 [整本小说分析可行性与实施计划](novel-analysis-feasibility-plan.md)：使用 G0029–G0036，覆盖 TXT 全文导入、多维提取、跨章整合、预算与恢复、综合报告及最终质量验收；附逐阶段进度和目标达成条件。G0029–G0034 已验收，当前 6/8 阶段、30/40 工作项，M2 报告候选可用，下一阶段 G0035。原 G0021 的模板采用和新书初始化保留为后续范围。
