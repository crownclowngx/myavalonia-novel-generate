...
G0044 已通过 441 项本地测试及隔离原生 Host 的报告、草案、版本与历史重开验收，真实模型与作者评阅仍待验。原生退出暴露的 Host/UI 排空顺序已在宿主内部修复，SDK 与数据格式不变；后续部署不能用单独更新插件替代配套宿主更新。具体证据、两书快照和验收边界见[G0044 验收矩阵](../refactoring/G0044/acceptance-matrix.md)。
