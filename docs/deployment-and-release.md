...
最近本机部署见 [1.0.1 DeepSeek 默认连接替换记录](deployments/2026-09-12-deepseek-defaults.md)：Release 构建和 288 项测试通过，已替换到 `D:\data\avalonia\Controls\NovelGeneratePlugin`。首次部署见 [Controls 初始部署记录](deployments/2026-09-12-local-controls.md)。
