...
<header class="topbar"><a class="brand" href="#overview"><span class="brand-mark" aria-hidden="true">N</span><span><strong>网络小说创作工作台</strong><small>NOVEL WORKBENCH / PRODUCT</small></span></a><div class="top-actions"><span class="status-chip">产品评审稿 · 未实施</span><a href="novel-generation-product-requirements.md">Markdown 原文 ↗</a><button class="plain-button" id="print-button" type="button">打印 / 存为 PDF</button></div></header>
<details class="mobile-nav"><summary>阅读目录</summary><nav aria-label="移动端目录">''' + mobile_toc + '''</nav></details>
<div class="layout"><aside class="sidebar"><div><p class="nav-kicker">DOCUMENT / V0.1</p><nav class="toc" aria-label="文档目录">''' + toc + '''</nav></div><div class="side-note">MYAVALONIA NOVEL GENERATE<br>2026.09.12 · 产品需求评审<div class="reading-line"><span id="reading-progress"></span></div><span>阅读进度 <span id="reading-percent">0%</span></span></div></aside>
<main class="content" id="main-content"><section class="hero" id="overview" aria-labelledby="product-title"><div class="hero-grid"><div><div class="eyebrow">PRODUCT BRIEF / 产品需求文档</div><h1 id="product-title">让创意成为<br>可持续创作的长篇。</h1><p class="hero-lead">面向个人中文网文创作者，把创意、规范和故事记忆放进同一个工作台。在明确范围与预算内连续起草，由作者掌握方向和最终定稿。</p></div><div class="hero-flow" aria-label="创意经过受限自动创作成为工作稿，作者审阅后形成正式稿"><div class="hero-flow-item"><span>01</span><div><b>作者给出创意与边界</b><small>方向 / 规则 / 范围 / 预算</small></div></div><div class="down" aria-hidden="true">↓</div><div class="hero-flow-item"><span>02</span><div><b>系统连续生成工作稿</b><small>规划 / 起草 / 检查 / 修正</small></div></div><div class="down" aria-hidden="true">↓</div><div class="hero-flow-item"><span>03</span><div><b>作者审阅与正式定稿</b><small>修改 / 选择 / 回退 / 导出</small></div></div></div></div><div class="meta-strip"><span><b>11</b>组功能需求</span><span><b>16</b>个首版验收场景</span><span><b>05</b>组产品示意</span><span><b>P0–P3</b>版本路线</span></div><p class="hero-caption"><span class="status-chip">设计阶段</span><span>以下为拟建设的产品方案；界面示意与示例正文不代表真实运行结果。</span></p></section>
<div class="intro" aria-label="原文说明">''' + render_blocks(intro_lines) + '''</div>
''' + '\n'.join(sections) + '''
<footer class="page-footer"><span>网络小说创作工作台 · 产品需求文档 v0.1</span><span>正文依据 Markdown 原文 · 示意图用于产品评审</span><a href="#overview">返回顶部 ↑</a></footer></main></div><div class="screen-reader" id="preview-announcement" role="status" aria-live="polite"></div>
