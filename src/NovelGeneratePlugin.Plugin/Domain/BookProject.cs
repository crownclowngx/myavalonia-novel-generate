...
public sealed record Chapter(Guid Id, Guid VolumeId, string Title, string Outline, string Text);
    ...
    public void Validate()
    {
        ...
        foreach (var chapter in Chapters)
            if (chapter is null || chapter.Id == Guid.Empty || !ids.Add(chapter.Id) ||
                !Volumes.Any(v => v.Id == chapter.VolumeId) || chapter.Title is null || chapter.Title.Length > 200 || chapter.Text is null || chapter.Outline is null)
